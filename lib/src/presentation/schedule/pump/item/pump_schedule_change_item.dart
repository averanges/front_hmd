...
import 'package:haimdall/src/presentation/schedule/pump/item/pump_schedule_change_item_controller.dart';
import 'package:intl/intl.dart';
import 'package:table_calendar/table_calendar.dart';
import 'package:tuple/tuple.dart';

class PumpScheduleChangeItem extends GetView<PumpScheduleChangeItemController> {
  final int index;
  final ValueChanged<Tuple2<DateTime, DateTime>> onSelectedRange;

  const PumpScheduleChangeItem({
    super.key,
    required this.index,
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
        tag: 'pump_schedule_change_item_$index',
        init: PumpScheduleChangeItemController(),
        builder: (controller) {
          return Column(
            children: [
  ...
  Widget _calendarView(
    PumpScheduleChangeItemController controller,
