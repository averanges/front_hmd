...
class PumpScheduleChangeRequestController extends GetxController {
  final FarmlandRepository farmlandRepository;
  final int farmlandId;

  PumpScheduleChangeRequestController({
  ...
  void onClickedOkButton() async {
    ...
    final result = await farmlandRepository.changePumpSchedule(
      farmlandId,
