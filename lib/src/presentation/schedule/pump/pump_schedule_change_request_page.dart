...
import 'package:haimdall/src/presentation/schedule/pump/item/pump_schedule_change_item.dart';
import 'package:haimdall/src/presentation/schedule/pump/pump_schedule_change_request_controller.dart';

class PumpScheduleChangeRequestPage
    extends GetView<PumpScheduleChangeRequestController> {
  const PumpScheduleChangeRequestPage({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<PumpScheduleChangeRequestController>(
      init: PumpScheduleChangeRequestController(
  ...
  Widget _titleView() => SizedBox(
        ...
        child: Stack(
          children: [
            ...
            TitleView(title: 'my_page_menu_pump_change'.tr),
          ],
        ),
      );
