...
class PumpChangeRequestHistoryController extends GetxController {
  final FarmlandRepository repository;
  final int farmlandId;

  PumpChangeRequestHistoryController({
    required this.repository,
    required this.farmlandId,
  });

  final isLoading = false.obs;
  final data = RxList<PumpChangeData>();
  ...
  void _fetchChangeRequestHistory() async {
    ...
    final result = await repository.getPumpChangeRequestList(farmlandId);
