...
import 'package:haimdall/src/presentation/history/change/awd/awd_change_request_history_controller.dart';
import 'package:intl/intl.dart';

class AwdChangeRequestHistoryPage
    extends GetView<AwdChangeRequestHistoryController> {
  const AwdChangeRequestHistoryPage({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<AwdChangeRequestHistoryController>(
      init: AwdChangeRequestHistoryController(
  ...
  Widget _titleView() => SizedBox(
        ...
        child: Stack(
          children: [
            ...
            TitleView(title: 'change_request_history_title'.tr),
          ],
        ),
      );
  ...
  Widget _listItemView(AwdChangeData data) => Container(
        height: 52.0,
