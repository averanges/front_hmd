...
class DrainWaterScheduleItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
        tag: 'drain_water_schedule_item_$index',
  ...
  Widget _plantingDateView(Rx<String> drainWaterPlantingDate,
    VoidCallback onTap,
  ) =>
      Obx(
        () {
  ...
  Widget _calendarView(ScheduleChangeItemController controller,
