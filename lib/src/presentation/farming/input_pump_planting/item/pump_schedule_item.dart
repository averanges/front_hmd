...
import 'package:haimdall/src/presentation/farming/input_pump_planting/item/pump_schedule_item_controller.dart';
import 'package:intl/intl.dart';
import 'package:table_calendar/table_calendar.dart';
import 'package:tuple/tuple.dart';

class PumpScheduleItem extends StatelessWidget {
  final int index;
  ...
  Widget build(BuildContext context) {
    return GetBuilder<PumpScheduleItemController>(
        tag: 'PumpScheduleItem$index',
        init: PumpScheduleItemController(),
        builder: (controller) {
          return Column(
            children: [
              _inputTitleView('input_pump_planting_index'.tr, index),
              const SizedBox(height: 8.0),
              _plantingDateView(
                controller.pumpPlantingDate,
                () => controller.onTapPumpPlanting(),
              ),
              Obx(() {
  ...
  Widget _plantingDateView(Rx<String> pumpPlantingDate, VoidCallback onTap) =>
      Obx(
        () {
          final period = pumpPlantingDate.value;
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        period.isEmpty ? 'input_pump_planting_hint'.tr : period,
                        style: TextStyle(
                          fontSize: 13.0,
                          color: period.isEmpty
  ...
  Widget _calendarView(
    PumpScheduleItemController controller,
    ...
    return Container(
      ...
      child: Obx(
        () => TableCalendar(
          ...
          rangeStartDay: controller.pumpStart.value,
          rangeEndDay: controller.pumpEnd.value,
